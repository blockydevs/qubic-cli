...
void print_help(){
    ...
    printf("\t\tUpload a file to qubic network. valid node ip/port and seed are required. optional DECOMPRESS_TOOL is use for decompress the file (support: zip, tar) \n");
    printf("\t-downloadfile <TX_ID> <FILE_PATH> [DECOMPRESS_TOOL]\n");
    printf("\t\tDownload a file to qubic network. valid node ip/port are required. optional DECOMPRESS_TOOL is use for decompress the file (support: zip, tar) \n");
